...
const ModalReservation = () => {
    ...
    return (
        <div className={`${openValue?'flex':'hidden'} absolute top-0 left-0 w-full flex flex-col items-center lg:bg-colorBd lg:bg-opacity-80 z-[2] lg:p-[25px]`}>
            <div onClick={() => dispatch(changeModalReservation(false))}
            ...
            <div className="max-w-[1110px] xs:mt-[105px] lg:mt-0 w-full bg-white px-[10px] py-[60px] flex flex-col items-center">
                ...
                <div className="mt-[60px] max-w-[992px] w-full flex flex-col items-center">
                    ...
                    <div className="flex gap-[40px] mt-[40px] xs:flex-col lg:flex-row">
                        ...
                        <div className="xs:min-w-[250px] lg:min-w-[430px] max-w-[430px] flex flex-col items-center">
                            <div className="flex flex-col px-[40px] py-[35px] bg-[#D0CCC7] bg-opacity-10 rounded-[20px]">
                                ...
                                <div className="mt-[40px] flex gap-[35px]">
                                    ...
                                    <p className="font-poppins xs:text-[12px] lg:text-[20px] xs:leading-[18px] lg:leading-[38px] font-[400]">Saturday, 28 february 2022</p>
                                </div>
                                <div className="mt-[25px] flex gap-[35px]">
                                    <img src="./img/reservation/icon_time.svg" alt="" />
                                    <p className="font-poppins xs:text-[12px] lg:text-[20px] xs:leading-[18px] lg:leading-[38px] font-[400]">04:30 pm</p>
                                </div>
                                <div className="mt-[25px] flex gap-[35px]">
                                    <img src="./img/reservation/icon_people.svg" alt="" />
                                    <p className="font-poppins xs:text-[12px] lg:text-[20px] xs:leading-[18px] lg:leading-[38px] font-[400]">2 people</p>
                                </div>
                            </div>
